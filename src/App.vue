...
export default {
        ...
        program: {
          ...
          blocks: [
            { type: 'hero', imageUrl: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=800' },
            {
              type: 'text',
              content:
                '<h2>4 weeks. Every body. Every goal.</h2><p>Transform your fitness journey with our comprehensive program designed for all fitness levels. Get access to workouts, nutrition guides, and community support.</p>',
            },
            {
              type: 'text',
              content:
                '<h3>What You Get</h3><ul><li>4 weeks of structured workouts</li><li>Nutrition guidance</li><li>Community access</li><li>Progress tracking</li><li>Expert support</li></ul>',
            },
            {
              type: 'text',
              content:
                "<h3>About the Program</h3><p>Our program is built on proven principles of progressive overload and sustainable habit formation. Whether you're just starting out or looking to level up, we meet you where you are.</p>",
            },
          ],
        },
        event: {
        ...
        sales: {
          ...
          blocks: [
            ...
            },
            {
              type: 'text',
              content:
                '<h3>Premium Features</h3><ul><li>Access to all programs</li><li>Unlimited live classes</li><li>1-on-1 coaching sessions</li><li>Custom meal plans</li><li>Priority support</li></ul>',
            },
            {
              type: 'text',
  ...
  computed: {
    currentPageData() {
      return this.pageData[this.activeTab]
    },
  },
}
</script>
